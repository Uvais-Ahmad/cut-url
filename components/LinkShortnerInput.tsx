    ...
    return (
        <div className='h-full'>
            <div className='w-3/4 mt-10 relative flex mx-auto  md:w-2/4 lg:w-2/5'>
                ...
                <input className='w-full rounded-full dark:bg-neutral-900 border-4 p-4 pl-12 sm:p-4 sm:pl-12' type='text' placeholder='Paste your link here' />
                <Button className='bg-blue-500 hidden w-30 lg:32 px-6 h-12 rounded-full absolute right-2 top-2 text-white p-3 sm:block sm:p-4 hover:bg-blue-400'>Shorten Now</Button>
