    ...
    return (
        <div className='h-full'>
            <div className='w-3/4 md:w-2/5 mt-10 relative flex mx-auto'>
                ...
                <button className='bg-blue-500 hidden sm:block w-40 absolute right-1 top-1 text-white p-4 px-6 rounded-full'>Shorten Now</button>
                <button className='bg-blue-500 block sm:hidden w-40 absolute right-1 top-1 text-white p-4 px-6 rounded-full'>
                    <MoveRight/>
                </button>
